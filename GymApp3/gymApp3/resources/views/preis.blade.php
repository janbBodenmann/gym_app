...
<section> 
  <div class="container max-w-full mx-auto py-12 px-6">
    ...
    <p class="text-center text-lg text-gray-700 mt-2 px-6">
      Sie wollen von unlimitierten Vorteilen verfügen, dann abonnieren Sie uns und erhalten sofortigen Access.
    </p>
        ...
        <div class="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 rounded-lg shadow-lg md:-mr-4">
          <div class="bg-white text-black rounded-lg shadow-inner shadow-lg overflow-hidden">
            <div class="block text-left text-sm sm:text-md max-w-sm mx-auto mt-2 text-black px-8 lg:px-6">
              ...
              <h2 class="text-sm text-gray-500 text-center pb-6">Gratis</h2>

              Geniessen Sie die gratis Version von unserer Gym App.
            </div>
			...
			></polyline>
                  ...
                  <span class="text-gray-700 text-lg ml-3">3 Tipps</span
	>
</li>
<li class="flex items-center">
	<div
...
>
	...
	></polyline>
                  ...
                  <span class="text-gray-700 text-lg ml-3">unlimitierter Aufenthalt</span>
                </li>
              </ul>
            </div>
	...
	Auswählen
        ...
        <div class="w-full max-w-md sm:w-2/3 lg:w-1/3 sm:my-5 my-8 relative z-10 bg-white rounded-lg shadow-lg">
          ...
          <div class="block text-left text-sm sm:text-md max-w-sm mx-auto mt-2 text-black px-8 lg:px-6">
            ...
            Geniessen Sie die Experten Version von unserer Gym App.
          </div>
          <div class="flex pl-12 justify-start sm:justify-start mt-3">
			...
			<polyline points="22 4 12 14.01 9 11.01"></polyline>
                ...
                <span class="text-gray-700 text-lg ml-3">20 Tipps</span>
              </li>
              <li class="flex items-center">
                <div class=" rounded-full p-2 fill-current text-green-700">
                  <svg class="w-6 h-6 align-middle" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
	...
	<polyline points="22 4 12 14.01 9 11.01"></polyline>
                ...
                <span class="text-gray-700 text-lg ml-3">7 Ernährungspläne</span
>
              </li>
              <li class="flex items-center">
                <div class=" rounded-full p-2 fill-current text-green-700">
        ...
        <div class="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 rounded-lg shadow-lg md:-ml-4">
          <div class="bg-white text-black rounded-lg shadow-inner shadow-lg overflow-hidden">
            <div class="block text-left text-sm sm:text-md max-w-sm mx-auto mt-2 text-black px-8 lg:px-6">
              ...
              Geniessen Sie die Unternehmen'<samp></samp> Version von unserer Gym App.
            </div>
            <div class="flex flex-wrap mt-3 px-6">
              <ul>
                <li class="flex items-center">
			...
			></polyline>
                  ...
                  <span class="text-gray-700 text-lg ml-3">unlimitierte Tipps</span
	>
</li>
<li class="flex items-center">
	<div
...
<span class="text-gray-700 text-lg ml-3"
>unlimitierte Ernährungspläne</span
>
                </li>
                <li class="flex items-center">
                  <div class=" rounded-full p-2 fill-current text-green-700">
...
<footer class="pt-4">
  <a href="https://www.instagram.com/jan.oo06" target="_blank">
  <div class="flex flex-row items-center justify-center">
  <span class="text-center font-sans border-b-2 border-blue-200 hover:text-blue-200">@Jan</span>
